const data = [
  ...
  function Card(user) {
    return React.createElement("div", { className: "user"} , [
      React.createElement("h1", null, [user.firstname]),
      React.createElement("h1", null, [user.lastname]),
      React.createElement("h4", null, [user.email]),
      React.createElement("h2", null, [user.gender]),
      React.createElement("h2", null, [user.age]),
      React.createElement("h2", null, [user.job]),
    ]);
  }
  function App() {
